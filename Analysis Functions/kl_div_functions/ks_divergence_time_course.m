function [ks_test, time_axis] = ks_divergence_time_course(ecog, onsets, fs, varargin)
...
%% Measure ks timecourse at each time point
ks_test = zeros(size(ecog_off,1), length(time_axis));

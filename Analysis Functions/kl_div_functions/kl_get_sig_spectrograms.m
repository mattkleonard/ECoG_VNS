function [kl_spectrograms, time_axis, f_axis] = kl_get_sig_spectrograms(VNS_dat, plot_out, varargin);
...
if plot_out
    ...
    if plot_spectrograms
        ...
        if save_figs
            ...
            saveas(gcf,[fig_dir filesep 'KL_Divergence_Spectrograms_sig' figure_appellation '.png']);
        end
    end
    if plot_time_series
        ...
        if save_figs
            ...
            pause(5)
            set(gcf, 'PaperPositionMode', 'auto')
            saveas(gcf,[fig_dir filesep 'KL_Divergence_TimeCourse_sig' figure_appellation '.png']);
        end
    end
a=1;

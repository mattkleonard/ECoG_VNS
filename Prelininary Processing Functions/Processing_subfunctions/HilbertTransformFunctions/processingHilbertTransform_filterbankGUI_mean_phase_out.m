function [filteredData,cfs,sigma_fs,hilbdata]=processingHilbertTransform_filterbankGUI_mean_phase_out(ecog,Fs,freqRange)
...
filteredData.data = angle(mean(filteredData.data,3));
